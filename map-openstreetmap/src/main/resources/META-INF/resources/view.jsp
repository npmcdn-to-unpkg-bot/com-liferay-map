...
<liferay-util:html-top outputKey="js_maps_openstreet_skip_loading">
	<link href="<%= protocol %>://unpkg.com/leaflet@0.7.3/dist/leaflet.css" rel="stylesheet" />
	<script src="<%= protocol %>://unpkg.com/leaflet@0.7.3/dist/leaflet.js" type="text/javascript"></script>
